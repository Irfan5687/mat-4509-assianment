...
## Problem with source 
.libPaths()
.libPaths("I:/rprograme")

install.packages("rstudioapi")
library(rstudioapi)
#Reading the Data
library(readxl)
Uaaos = read_excel("United Airlines Aircraft Operating Statistics.xls", col_names = TRUE)
Uaaos
# If the file extension is .xls, use:
data_file <- "United Airlines Aircraft Operating Statistics.xls"
...
maintenance_rows <- c(15, 54, 93, 132)
load_factor_rows <- c(32, 71, 110, 149)
...
lapply(1:4, function(i) {
  ...
  pie(data, 
      ...
      border = "green")      # Add border to slices
})
